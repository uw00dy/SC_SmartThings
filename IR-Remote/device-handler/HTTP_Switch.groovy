...
preferences {
	section("External Access"){
		input "external_on_uri", "text", title: "External On URL", required: false
		input "external_off_uri", "text", title: "External Off URL", required: false
	}
	...
	section("Internal Access"){
		...
		input "internal_on_path", "text", title: "Internal On Path (/ir?)", required: false
		input "internal_off_path", "text", title: "Internal Off Path (/ir?)", required: false
	}
}
...
metadata {
	definition (name: "HTTP Switch", namespace: "smartthings", author: "Soon Chye") {
		capability "Actuator"
			capability "Switch"
			capability "Sensor"
	}
