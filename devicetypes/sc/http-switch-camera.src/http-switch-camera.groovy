...
metadata {
	definition (name: "HTTP Switch Camera", namespace: "sc", author: "SC") {
        capability "Switch"
	...
	preferences {
		...
		input("DevicePathOn1", "string", title:"URL1 Path for ON", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
		input("DevicePathOn2", "string", title:"URL2 Path for ON", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
       	input("DevicePathOn3", "string", title:"URL3 Path for ON", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
		input("DevicePathOff1", "string", title:"URL1 Path for OFF", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
		input("DevicePathOff2", "string", title:"URL2 Path for OFF", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
		input("DevicePathOff3", "string", title:"URL3 Path for OFF", description: "Rest of the URL, include forward slash.", displayDuringSetup: true)
...
def on() {
	def DevicePathOn = DevicePathOn1 + DevicePathOn2 + DevicePathOn3
...
def off() {
	def DevicePathOff = DevicePathOff1 + DevicePathOff2 + DevicePathOff3
